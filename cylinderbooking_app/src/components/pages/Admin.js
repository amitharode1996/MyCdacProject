...
export default class Admin extends Component {
    ...
    render() {
        return (
            <BrowserRouter>
            <div>
                <h1 style={{color:"ThreeDDarkShadow",backgroundColor:"lightgreen"}}> Welcome Admin { JSON.parse(localStorage.getItem("loggedinuser")).name}</h1>
                   <ul className="nav nav-tabs">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="/LatestBooking" style={{ color: "white" }}>Latest Booking </Link>
                    </li>
                    <li className="nav-item">
