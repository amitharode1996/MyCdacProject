                ...
                <div className="container " >
                    <div className="row no-gutters " style={{ padding: "10px" }}>
                        <div className="col-lg-5 my-16 p-12">
                            <img src="./images/cylinder.jpg" className="img-fluid" style={{ marginTop: "15px" }} alt="Image Cylinder" />
                        </div>
                        <div className="col-lg px-5">
                            ...
                            <form >
                                ...
                                <br />
                                <button className="btn btn-warning" onClick={this.forgetForm} >Forgot Password</button><span> </span>
                                <br />
                                <br/>
